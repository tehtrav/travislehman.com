...
window.RenderScopes = function(scopes){
	...
	for(var i in scopes) {
		...
		$visual.append($('<img class="scope-ads" src="resources/images/scope-images/compressed/' + scopes[i].Name.toLowerCase().replace(/\s+/g, "-").replace(/'/g, '') + '-ads.png" />'));
		$visual.append($('<img class="scope-hip" src="resources/images/scope-images/compressed/' + scopes[i].Name.toLowerCase().replace(/\s+/g, "-").replace(/'/g, '') + '.png" />'));
